...
OTHER_CATEGORIES = "REDACTED_MERCHANT and REDACTED_MERCHANT are each a FOOD category. REDACTED_MERCHANT is a GAS category. "
...
def extract_boa_transactions(documents: list[Document]) -> list[str]:
    transactions = []
...
def categorize_boa(model: any, transactions: list[str]) -> list[dict]:
